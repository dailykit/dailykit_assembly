...
public class ContinuousScanIngredientAdapter extends RecyclerView.Adapter<ContinuousScanIngredientAdapter.SingleItemRowHolder> {

    public static final String TAG = "ContinuousScanAdapter";
    ...
    private ContinuousScanActivity activity;
    ...
    public ContinuousScanIngredientAdapter(Activity activity, List<IngredientEntity> ingredientEntityList, ItemEntity itemEntity, int numberOfPackedIngredients) {
        this.ingredientEntityList = ingredientEntityList;
        this.ingredientFragment = ingredientFragment;
        this.activity =(ContinuousScanActivity)activity;
    ...
    @Override
    public ContinuousScanIngredientAdapter.SingleItemRowHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ingredient_list, parent,false);
        ContinuousScanIngredientAdapter.SingleItemRowHolder rowHolder = new ContinuousScanIngredientAdapter.SingleItemRowHolder(v);
    ...
    @Override
    public void onBindViewHolder(final ContinuousScanIngredientAdapter.SingleItemRowHolder holder, final int position) {
